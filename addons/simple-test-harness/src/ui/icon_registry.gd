...
const ICON_RUN_TEST_METHOD:Texture2D = preload("res://addons/simple-test-harness/assets/icon_run_test_method.png")
...
const ICON_DEBUG_TEST_METHOD:Texture2D = preload("res://addons/simple-test-harness/assets/icon_debug_test_method.png")
